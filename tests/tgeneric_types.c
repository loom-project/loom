/*
Unit testing code for generic types.
...
void test_u8(void) {
    ...
    NP_ASSERT_PTR_EQUAL(generic_name(u8), generic_u8_name);
...
void test_u16(void) {
    ...
    NP_ASSERT_PTR_EQUAL(generic_name(u16), generic_u16_name);
...
void test_u32(void) {
    ...
    NP_ASSERT_PTR_EQUAL(generic_name(u32), generic_u32_name);
...
void test_u64(void) {
    ...
    NP_ASSERT_PTR_EQUAL(generic_name(u64), generic_u64_name);
...
void test_s8(void) {
    ...
    NP_ASSERT_PTR_EQUAL(generic_name(s8), generic_s8_name);
...
void test_s16(void) {
    ...
    NP_ASSERT_PTR_EQUAL(generic_name(s16), generic_s16_name);
...
void test_s32(void) {
    ...
    NP_ASSERT_PTR_EQUAL(generic_name(s32), generic_s32_name);
...
void test_s64(void) {
    ...
    NP_ASSERT_PTR_EQUAL(generic_name(s64), generic_s64_name);
...
void test_string(void) {
    generic_t *string1, *string2;
    char str[] = "0123456789abcdef";

    /* const string */
    string1 = generic_string(NULL, str);
    NP_ASSERT_NOT_NULL(string1);
    NP_ASSERT_PTR_EQUAL(generic_name(string1), generic_string_name);
    ...
    /* dup string */
    string2 = generic_string_dup(NULL, str);
    NP_ASSERT_NOT_NULL(string2);
    NP_ASSERT_PTR_EQUAL(generic_name(string2), generic_string_name);
...
void test_buffer(void) {
    generic_t *buffer1, *buffer2;
    uint8_t buf[] = {0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef};

    /* const buffer */
    buffer1 = generic_buffer(NULL, buf, sizeof(buf));
    NP_ASSERT_NOT_NULL(buffer1);
    NP_ASSERT_PTR_EQUAL(generic_name(buffer1), generic_buffer_name);
    ...
    /* dup buffer */
    buffer2 = generic_buffer_dup(NULL, buf, sizeof(buf));
    NP_ASSERT_NOT_NULL(buffer2);
    NP_ASSERT_PTR_EQUAL(generic_name(buffer2), generic_buffer_name);
